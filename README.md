...
Q: Describe creates block that groups together several related tests.'It' is used when individual tests are performed, and contain all of the actual testing logic.
